...
<div class="row">
    <div class="col-md-10 mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo URL_ROOT; ?>/teachers/editTest/<?php echo $id; ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <?php if(!empty($all_questions)) : ?>
                        <div class="d-grid">
                            <input type="submit" value="Update Test" class="btn btn-success">
                        </div>
                    <?php endif; ?>
                </form>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateButtonText() {
        ...
        if (updateButton) {
            updateButton.value = `Update Test (${checkedCount} questions selected)`;
        }
    }
